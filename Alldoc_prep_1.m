...
folder0='/Users/office/Downloads/MCMC/MCMCRunData_V2/MCMC_4FREQ_NEW/MCMC_1/';
mkdir(folder0);
cd(folder0)
if(0)
    open prep_filename
...
%% Basic settings !!!
prior_type='gp';  %'gp'=good prior; 'bp'=vic or nldas prior
...
model='hut';   %'emp'=empirical memls; 'iba'='iba','hut'=hut model combination
stdTb=2.0;
